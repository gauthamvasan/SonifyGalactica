...
## Load data
df = pd.read_csv('/Users/gautham/src/SonifyGalactica/sonify/data/lunarCraterAges.csv')  #load data as a pandas dataframe
n_impacts = len(df)
...
# Set the instrument (program change) for the track
guitar_program = 25  # Replace with the program number for a guitar instrument
my_midi_file.addProgramChange(0, 0, 0, guitar_program)
